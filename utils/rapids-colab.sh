...
if (( $RAPIDS_RESULT >= 11 )) ;then
  ...
  echo " "
  echo "SCRIPT TO COPY: "
  echo "!wget -nc https://raw.githubusercontent.com/luskaner/notebooks-contrib/main/utils/rapids-colab.sh"
  ...
  if [ $response == "Y" ] || [ $response == "y" ] ;then
    ...
    echo " "
    echo "SCRIPT TO COPY:"
    echo "!wget -nc https://raw.
    usercontent.com/rapidsai/notebooks-contrib/master/utils/rapids-colab.sh"
    echo "!bash rapids-colab.sh"
    echo "import sys, os"
    echo "dist_package_index = sys.path.index\('/usr/local/lib/python3.6/dist-packages'\)"
    echo "sys.path = sys.path[:dist_package_index] + ['/usr/local/lib/python3.6/site-packages'] + sys.path[dist_package_index:]"
...
wget -nc https://github.com/luskaner/notebooks-contrib/raw/main/utils/env-check.py
...
if [ ! -f Miniconda3-4.5.4-Linux-x86_64.sh ]; then
    ...
    # install RAPIDS packages
        ...
        wget -nc https://github.com/luskaner/notebooks-contrib/raw/main/utils/update_pyarrow.py
